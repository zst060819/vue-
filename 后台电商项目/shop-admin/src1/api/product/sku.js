...
export default {
  ...
  //根据SPU的商品的id获取当前这个spu商品下所有的sku的商品对象信息列表数据
  getSkuInfoListBySpuId(skuId) {
    return request.get(`${API_NAME}/findBySpuId/${skuId}`)
  },
  //根据SPU的商品的id获取当前这个spu商品详细信息对象
  getSkuInfoSkuId(skuId) {
